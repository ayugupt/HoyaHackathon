    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row" >
                    <div class="col-md-6 offset-md-1 col-6 col-sm-12" >
                ...
                <div class="card col-md-10 offset-md-1" id="appointment_card">
                    <div class="card-body" id="appointment_result">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="row" id="supply_chain_heading">
                            <div class="col-md-12">
                                Supply Chain
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card" id="supply_chain">
                                    <div class="card-body" id="supply_chain_body">
                                        <div class="row" >
                                            <div class="col-md-12" >
                                                <img src="assets/img/supply-chain-management.png" alt="" id="supply_chain_picture">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <a class="btn btn-primary supply_chain_btn" href="dashboard.html" role="button">Acess Page</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-6">
                        <div class="row" id="patient_log_heading">
                            <div class="col-md-12">
                                Patient Log
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card" id="patient_log">
                                    <div class="card-body" id="patient_log_body">
                                        <div class="row" >
                                            <div class="col-md-12" >
                                                <img src="assets/img/medical-records.png" alt="" id="patient_log_picture">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <a class="btn btn-primary patient_log_btn" href="page_2.php" role="button">Acess Page</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
